...
FILE_FB_CREDS = '../../../credentials/quiz-it-c6643-firebase-adminsdk-32pqc-574194610f.json'
FB_URL = 'https://quiz-it-c6643.firebaseio.com'

# sheet details
SPANISH = {'id': '1LW69o3iJeJZUGCrJ1HfX19gMZXQNR0jGNbvscB6zQQA', 'name': 'WordList'}
...
def main():
    ...
    try:
        ...
        pass
    Firebase.set_df(df, FB_URL, 'items')
